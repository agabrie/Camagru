<?php
	...
	$db->insertRecord(array("table"     =>array("name"=>"USERS",
							...
							"values"	=>array(stringify($_SESSION["username"]),stringify($_SESSION["fname"]),stringify($_SESSION["lname"]),stringify($_SESSION["email"]),stringify($_SESSION["passwrd"]), '0', $db->gallerycount(),'1')
		));
